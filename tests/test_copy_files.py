...
def test_copy_file_failure_io_error(mocker):
    ...
    mock_copy = mocker.patch("app.copy_files.copy2", side_effect=IOError)
...
def test_copy_file_failure_os_error(mocker):
    ...
    mock_copy = mocker.patch("app.copy_files.copy2", side_effect=OSError)
...
def test_copy_file_failure_file_not_found(mocker):
    ...
    mock_copy = mocker.patch("app.copy_files.copy2", side_effect=FileNotFoundError)
